        ...
        <div className="greet-page" id="CS">
            ...
            <Container >
                ...
                <Row>
                    ...
                    <br />
                    <p>I user tested the site and gained a lot of perspective from my users. Like every other developer before, my app was not quite as intuitive as I had hoped. Many had never used tinder before and did not understand the swipe. They viewed the thumbs up and down as ratings. They thought they were going to meet people who also wanted to watch the movies they wanted to watch (I stopped telling people it was like Tinder for Netflix after that. No leading statements, learned that the hard way.) I made adjustments and came up with solutions to those problems.</p>
                    <br />
